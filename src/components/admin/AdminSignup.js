    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-8">Admin Registration</h2>
          <form onSubmit={handleRegister} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 ml-16 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                    required
                  />
                </div>
              </div>
            ...
            <div>
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 pr-40 flex items-center pointer-events-none">
            ...
            <div>
              ...
              <input
                ...
                value={role}
                disabled
                className="block w-full pl-3 pr-3 py-2 border border-gray-300 rounded-lg bg-gray-100 focus:ring-0"
              />
            </div>
            ...
            >
              {btnLoading ? (
                ...
                <>
                  Register <ChevronRight className="ml-2 h-5 w-5" />
                </>
              )}
            </button>
          </form>
